...
namespace Solution.View
{
    internal class DxPlay : IDisposable
    {
        ...
        // Plays a video shot
        public void PlayShot(int startFrame, int endFrame)
        {
            long longStartFrame = (long) startFrame;
            long longEndFrame = (long) endFrame;

            // From: http://msdn.microsoft.com/en-us/library/windows/desktop/dd407038(v=vs.85).aspx
