; ModuleID = 'test/dynamic_overflow.checked.bc'
...
@__file = private unnamed_addr constant [19 x i8] c"dynamic_overflow.c\00"
...
; <label>:1                                       ; preds = %entry
  call void (i8*, i8*, i32, ...)* @__assert(i8* getelementptr inbounds ([30 x i8]* @__assertion, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8]* @__file, i32 0, i32 0), i32 2), !dbg !4
  unreachable, !dbg !4
