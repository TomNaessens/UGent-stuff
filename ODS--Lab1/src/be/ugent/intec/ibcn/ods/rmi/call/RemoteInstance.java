    ...
    public boolean equals(Object obj) {
        if (obj instanceof RemoteInstance) {
            ...
            boolean localInstanceId = 
                    ((getInstanceId() == null ? ri.getInstanceId() == null : getInstanceId().equals(ri.getInstanceId())) // Singleton case
                  || (getInstanceId() != null && getInstanceId().equals(ri.getInstanceId()))); // Not singleton case
