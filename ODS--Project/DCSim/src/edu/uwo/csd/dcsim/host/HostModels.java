...
public final class HostModels {
	...
	public static Host.Builder ProLiantDL380G6EightCore(Simulation simulation) {
		...
		return new Host.Builder(simulation).nCpu(2).nCores(4).coreCapacity(2400).memory(8192).bandwidth(12800).storage(36864).powerModel(powerModel);
	}
	...
	public static Host.Builder ProLiantML110G5(Simulation simulation) {
		...
		return new Host.Builder(simulation).nCpu(1).nCores(2).coreCapacity(2660).memory(4096).bandwidth(1310720).storage(36864).powerModel(powerModel);
                //return new Host.Builder(simulation).nCpu(1).nCores(16).coreCapacity(2660).memory(4096).bandwidth(1310720).storage(36864).powerModel(powerModel);
	}
        
        public static Host.Builder VirtualWallHost(Simulation simulation) {
		//Power Efficiency: 39.41 cpu/watt
		HostPowerModel powerModel = new LinearHostPowerModel(10, 80);
		
                return new Host.Builder(simulation).nCpu(1).nCores(16).coreCapacity(2400).memory(12190).bandwidth(12800).storage(61440).powerModel(powerModel);
	}
